    ...
    <Router>
      <CartProvider>
        <div>
          ...
          <Routes>
            <Route path="/" element={<Home handleCartItemCountChange={handleCartItemCountChange} isLoggedIn={loggedIn} user={user} />} />
            <Route path="/about" element={<About />} />
            <Route path="/boys" element={<Boys handleCartItemCountChange={handleCartItemCountChange} isLoggedIn={loggedIn} user={user} />} />
            <Route path="/girls" element={<Girls handleCartItemCountChange={handleCartItemCountChange} isLoggedIn={loggedIn} user={user} />} />
            <Route path="/category/0-4-years" element={<AgeGroup0To4 handleCartItemCountChange={handleCartItemCountChange} isLoggedIn={loggedIn} user={user} />} />
            <Route path="/category/4-10-years" element={<AgeGroup4To10 handleCartItemCountChange={handleCartItemCountChange} isLoggedIn={loggedIn} user={user} />} />
            <Route path="/category/10-years" element={<AgeGroup10Plus handleCartItemCountChange={handleCartItemCountChange} isLoggedIn={loggedIn} user={user} />} />
